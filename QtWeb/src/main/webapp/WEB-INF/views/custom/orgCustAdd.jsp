...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>组织客户新增</legend>
</fieldset>
<blockquote class="layui-elem-quote">组织客户新增</blockquote>
<form id="orgCustomInfo" class="layui-form" action="">
...
<script type="text/javascript">
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(sub)', function (data) {
            $.post("/cust/org/addorgcust", {data: JSON.stringify(data.field)}, function (json, status) {
                if (status == "success") {
                    layer.msg(json.msg);
                    if (json.code == "200") {
                        setTimeout(function () {
