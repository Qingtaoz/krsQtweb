...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>组织客户列表</legend>
</fieldset>
<blockquote class="layui-elem-quote">组织客户列表</blockquote>
<div id="dt_customer" class="dt_wrapper">
    ...
    <span class="fl">
        ...
        <div class="layui-input-inline">
            <input id="input_search" type="text" autocomplete="off" placeholder="搜索客户编码或名称" class="layui-input">
        </div>
